...
*/
  ...
  function save() {
    ...
    window.localStorage.setItem("Widget_Config", JSON.stringify(widgetConfig));
  }

  useEffect(() => {
    const data = window.localStorage.getItem("Widget_Config");
    setWidgetConfig(JSON.parse(data) || DEFAULT_CONFIG);
  }, []);
